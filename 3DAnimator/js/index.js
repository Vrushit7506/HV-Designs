...
function init() {
  ...
  l1.load(
    "https://raw.githubusercontent.com/Vrushit7506/3d-shader-image-transition/master/2.jpg",
    function (img) {
      slide.setImage(img);
    }
  );
  ...
  l2.load(
    "https://raw.githubusercontent.com/Vrushit7506/3d-shader-image-transition/master/alberto-castillo-q-mx4mSkK9zeo-unsplash.jpg",
    function (img) {
      slide2.setImage(img);
    }
  );
